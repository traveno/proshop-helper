...
chrome.runtime.onMessage.addListener(
    function (request, sender, sendResponse) {
        ...
        if (request.type == "wo-number") {
            ...
            document.getElementById("loadingText").innerHTML = "Searching part stocks & purchase orders";
        }
        ...
        if (request.type == "finishedSearch") {
            ...
            for (const info of partStockInfos) {
                $("#floater-inner").append("<button class=\"partStockButton\" id=\"" + info.po + "\">PO: " + info.po + "\nLINE: " + info.line + "\nDATE REC'D: " + info.arrived + "\nQTY: " + info.qty + "</button></br>");
...
function addNonPartStockOptions() {
    $("#floater-inner").append("<button class=\"partStockButton\" id=\"omit\">Omit part stock information</button></br>");
